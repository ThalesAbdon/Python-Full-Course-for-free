...
sorteados_original = [10, 3, 11, 18, 5, 14, 19, 4, 25, 7, 20, 1, 23, 6, 24]
sorteados_ordenados = sorted(sorteados_original)

lista1 = [1, 2, 4, 5, 9, 10, 11, 12, 13, 14, 19, 20, 22, 24, 25]
lista2 = [4, 5, 7, 9, 10, 14, 15, 16, 17, 19, 20, 21, 22, 23, 24]
lista3 = [1, 3, 4, 5, 7, 8, 9, 10, 11, 12, 13, 17, 20, 22, 25]
lista4 = [1, 3, 5, 7, 8, 9, 11, 12, 18, 19, 20, 21, 22, 24, 25]
lista5 = [1, 2, 4, 6, 9, 11, 13, 14, 15, 16, 17, 18, 19, 22, 24]
lista6 = [1, 3, 4, 5, 7, 9, 10, 11, 12, 13, 15, 17, 18, 19, 20, 21, 22, 24, 25]
